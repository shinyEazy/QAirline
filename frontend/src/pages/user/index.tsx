...
const UserPage = () => {
  ...
  const [openDialog, setOpenDialog] = useState(false); // For modal state
  const [selectedTicketId, setSelectedTicketId] = useState<number | null>(null); // To store the selected ticket ID
  ...
  const handleCloseDialog = () => {
    setOpenDialog(false); // Close the dialog without changing anything
    setSelectedTicketId(null); // Reset the selected ticket ID
  };
